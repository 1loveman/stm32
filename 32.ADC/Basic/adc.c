...
void ADC_DMA_Init(void){
    ...
    DMA_InitS.DMA_PeripheralBaseAddr=ADC_DR_ADDR;
    DMA_InitS.DMA_MemoryBaseAddr=(u32)&ADC_DMA_IN5;
    DMA_InitS.DMA_DIR=DMA_DIR_PeripheralSRC;
    DMA_InitS.DMA_BufferSize=1;
    DMA_InitS.DMA_PeripheralInc=DMA_PeripheralInc_Disable;
    DMA_InitS.DMA_MemoryInc=DMA_MemoryInc_Disable;
